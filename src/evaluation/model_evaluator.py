...
from rec_errors import squared_euclidean_norm
from autoencoder_model import AutoEncoderModel


class ModelEvaluator():

    def __init__(self, model: AutoEncoderModel):
        self.__model = model
    ...
    def build(self):
        ...
        self.__tensor_rec_error = tf.reduce_sum(squared_euclidean_norm(self.__tensor_rec_error_x, 
