...
from architectures.fashionmnist_architecture_provider import FashionMnistArchitectureProvider

from dataset_loaders import load_mnist_data, load_cifar10_data, create_cifar10_dataset, create_mnist_dataset
from dataset_loaders import load_fashionmnist_data, create_fashion_mnist_dataset
...
def get_dataset_loader(dataset_name, batch_size: int):
    if dataset_name == 'fashion_mnist':
        tr_images, ts_images = load_fashionmnist_data()
        return lambda: create_fashion_mnist_dataset(tr_images, ts_images, batch_size)
...
def get_architecture_provider(dataset_name: str):
    if dataset_name == 'mnist':
        ...
        return FashionMnistArchitectureProvider()
    elif dataset_name == 'cifar10':
